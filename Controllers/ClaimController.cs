...
using ST10040092_Nikhil_POE_Part2_PROG6212.Data;
using AppClaim = ST10040092_Nikhil_POE_Part2_PROG6212.Models.Claim;
using OfficeOpenXml;
...
public class ClaimsController : Controller
    {
        ...
        public async Task<IActionResult> SubmitClaim(AppClaim claim, IFormFile document)
        {
            ...
            if (claim.HourlyRate > 500 || claim.HoursWorked > 200)
            {
